        ...
        <header className='fixed z-50 w-screen p-6 px-16'>
            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                <div className='flex items-center gap-2'>
                    ...
                    <MdCoffee className='w-16 object-cover cursor-pointer text-6xl hover:text-gradientBg'></MdCoffee>
                ...
                <div className='flex items-center gap-8'> {/* bo ra ngoai div nay thi no se nam giua */}
                    ...
                    <img className='w-10 min-w-[40px] h-10 min-h-[40px] drop-shadow-xl' src={Avata} alt="avata nguoi dung"></img>
                </div>
            </div>
            {/* mobile */}
