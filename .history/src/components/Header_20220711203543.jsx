        ...
        <header className='fixed z-50 w-screen p-6 px-16'>
            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                <div className='flex items-center gap-2'>
                    {/* <img src={Logo} className="w-16 object-cover" alt="Logo nef"/> */}motion.img  
                    <motion.MdCoffee whileTap={{scale: 0.6}}className='w-16 object-cover cursor-pointer text-6xl hover:text-cartNumBg'></motion.MdCoffee>
