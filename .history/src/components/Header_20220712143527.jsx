                ...
                <div className='flex items-center gap-8'> {/* bo ra ngoai div nay thi no se nam giua */}
                    ...
                    <div className='relative'>
                        ...
                        <div className='w-40 bg-gray-50 shadow-xl rounded-lg absolute flex flex-col top-12 right-0'>
                            ...
                            <p className='px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base'>Logout <MdAccountCircle/></p>
                        </div>
                    </div>
                </div>
            </div>
