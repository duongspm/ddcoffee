                        ...
                        {/* Menu In4 */}
                        {
                            ...
                            (
                                <motion.div 
                                    ...
                                    <Link to={'/info'}>
                                        <p className='px-4 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out text-textColor text-base'><MdAccountCircle/>{user ? user. : Avatar} In4 </p>
                                    </Link>
                                    <hr/>
