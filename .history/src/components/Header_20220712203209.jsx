            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                ...
                <div className='flex items-center gap-8'> {/* bo ra ngoai div nay thi no se nam giua */}
                    <motion.ul 
                        ...
                        <li className='text-base text-textColor hover:text-cartNumBg duration-100 transition-all ease-in-out cursor-pointer' onClick={()=>}>Menu</li>
                        <li className='text-base text-textColor hover:text-cartNumBg duration-100 transition-all ease-in-out cursor-pointer' onClick={()=>}>About Us</li>
                    </motion.ul>
