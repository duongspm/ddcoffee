        ...
        <header className='fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary'>
            ...
            <div className='hidden md:flex w-full h-full items-center justify-between'>
                <Link to={"/"} className='flex items-center gap-2'>
                    ...
                    <motion.p whileTap={{scale: 0.6}}  className='text-headingColor text-xl font-bold'><span className='text-green-800 text-[3rem] lg:text-[5rem]'>DD</span> Cup & Tea</motion.p>
                </Link>
                <div className='flex items-center gap-8'> {/* bo ra ngoai div nay thi no se nam giua */}
                    <motion.ul 
                        ...
                        <li className='text-base text-textColor hover:text-cartNumBg duration-100 transition-all ease-in-out cursor-pointer' onClick={()=>setIsMenu(false)}>Menu</li>
                        <li className='text-base text-textColor hover:text-cartNumBg duration-100 transition-all ease-in-out cursor-pointer' onClick={()=>setIsMenu(false)}>About Us</li>
                    </motion.ul>
