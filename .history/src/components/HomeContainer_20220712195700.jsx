            ...
            <div className='py-2 flex-1 flex items-center relative'>
                ...
                <div className='w-full h-full absolute flex items-center justify-center top-0 left-0 px-32 py-4'>
                    {heroData && heroData.map(n => (
                        <div key={n.id} className='w-190 bg-cardOverlay backdrop-blur-md p-4 rounded-3xl flex flex-col items-center justify-center'>
                        <img src={n.imageS} className='w-40 -mt-20' alt='i1'/>
                        <p className='text-xl font-semibold text-textColor mt-6'>Càfê</p>
                        <p className='text-sm font-semibold text-lighttextGray my-3'>Cafe Đen</p>
                        <p className='text-sm font-semibold text-headingColor'>20.000 <span className='text-xs text-red-600'>VNĐ</span></p>
                    </div>
                    ))}
                </div>
            </div>
