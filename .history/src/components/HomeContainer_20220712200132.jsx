    ...
    return (
        <section id="home" className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full'>
            ...
            <div className='py-2 flex-1 flex items-center relative'>
                ...
                <div className='w-full h-full absolute flex items-center justify-center top-0 left-0 px-32 py-4 gap-2 flex-wrap'>
                    {heroData && heroData.map(n => (
                        <div key={n.id} className='w-190 bg-cardOverlay backdrop-blur-md p-4 rounded-3xl flex flex-col items-center justify-center min-w-[100px]'>
