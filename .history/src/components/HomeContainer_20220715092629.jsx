    ...
    return (
        <section id="home" className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full'>
            <div className='py-2 flex flex-1 flex-col items-start  justify-center gap-8'>
                ...
                <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>People drink coffee to relieve mental and physicl fatigue and to increase metal alertness. Coffee is also used to prevent. Parkison's disease gallstones, type 2 diabe</p>
                <button type='button' className='bg-gradient-to-br from-green-600 to-green-800 w-full px-4 py-2 rounded-lg hover:shadow-lg transition-all ease-in-out md:w-auto text-white'>Order Now</button>
            </div>
